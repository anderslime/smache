...
def test_performance_users_100(benchmark):
    run_benchmark(benchmark, 100)

def test_performance_users_200(benchmark):
    run_benchmark(benchmark, 200)

def test_performance_users_400(benchmark):
    run_benchmark(benchmark, 400)

def test_performance_users_800(benchmark):
    run_benchmark(benchmark, 800)

def test_performance_users_1600(benchmark):
