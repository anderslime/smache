...
def test_argument_updates_with_db_small(benchmark):
    run_benchmark('small', benchmark)

def test_argument_updates_with_db_medium(benchmark):
    run_benchmark('medium', benchmark)

def test_argument_updates_with_db_large(benchmark):
    run_benchmark('large', benchmark)

def test_argument_updates_with_db_humongous(benchmark):
